...
import org.openqa.selenium.firefox.FirefoxDriver;
	...
	public class TC_RF_009 
	{
	    ...
	    public static void main(String[] args) 
	    {
	        ...
	        // Test Step 3: Enter existing Account Details into all the Fields and click on continue button
	        ...
	        if (warningMessage.getText().contains("Warning: E-Mail Address is already registered!")) 
	        {
