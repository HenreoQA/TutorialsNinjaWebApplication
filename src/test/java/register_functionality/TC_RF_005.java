...
public class TC_RF_005 {
    public static void main(String[] args) {
        ...
        try {
            ...
            driver.findElement(By.id("input-email")).sendKeys("tom859harry@yahoo.com");
            ...
            // Step 4: Click on 'Yes' radio option for Newsletter
         ...
         // Expected result 1: User should be logged in and taken to 'Account Success' page
          ...
          // Expected result 3: 'Yes' option should be displayed as selected by default in the Newsletter page
            WebElement newsletterYesSelected = driver.findElement(By.xpath("//input[@name='newsletter'][@value='1']"));
            assert newsletterYesSelected.isSelected() : "'Yes' option is not selected by default in the Newsletter page.";

            System.out.println("Test case passed: User registered and 'Yes' option for Newsletter is selected by default.");
