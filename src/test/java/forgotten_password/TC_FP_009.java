        ...
        try {
         ...
         // Fetch the reset email
            ...
            if (resetLink != null) {
                ...
                // Leave the 'Password' and 'Confirm' fields empty
                ...
                WebElement passwordError = driver.findElement(By.xpath("//div[contains(text(),'Password must be between 4 and 20 characters!')]"));
                if (passwordError.isDisplayed()) {
                    System.out.println("Test passed: Correct error message is displayed");
                } else {
                    System.out.println("Test failed: Correct error message is not displayed");
                }            
              } 
            else 
            {
