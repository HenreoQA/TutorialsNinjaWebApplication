	...
	public static void main(String[] args) {
        ...
        try {
            ...
            if (resetLink != null) {
                ...
                WebElement pageHeading = driver.findElement(By.cssSelector("div#content h1"));
                String expectedHeading = "Reset Your Password";
                String actualHeading = pageHeading.getText();
                if (expectedHeading.equals(actualHeading)) {
                    System.out.println("Test Passed: Correct page heading is displayed");
                } else {
                    System.out.println("Test Failed: Incorrect page heading");
                }

                // Verify the Page URL
                String expectedUrl = "http://tutorialsninja.com/demo/index.php?route=account/reset";
                String actualUrl = driver.getCurrentUrl();
                if (actualUrl.contains(expectedUrl)) {
                    System.out.println("Test Passed: Correct page URL is displayed");
                } else {
                    System.out.println("Test Failed: Incorrect page URL");
                }

                // Verify the Page Title
                String expectedTitle = "Reset Your Password";
                String actualTitle = driver.getTitle();
                if (expectedTitle.equals(actualTitle)) {
                    System.out.println("Test Passed: Correct page title is displayed");
                } else {
