        ...
        try {
         ...
         // Fetch the reset email
            ...
            if (resetLink != null) {
                ...
                // Enter text into 'Password' and 'Confirm' fields on the 'Reset your Password' page
                ...
                //Ensure the text entered is hidden (i.e., displayed as * or ●)
                ...
                if (passwordFieldType.equals("password") && confirmPasswordFieldType.equals("password")) {
                    System.out.println("Test Passed: Password and Confirm fields are properly masked");
                } else {
                    System.out.println("Test Failed: Password and/or Confirm fields are not properly masked");
                }     
            }
            else 
            {
